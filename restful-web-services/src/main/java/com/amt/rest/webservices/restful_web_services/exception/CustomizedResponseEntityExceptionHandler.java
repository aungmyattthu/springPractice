...
import com.amt.rest.webservices.restful_web_services.user.UserNotFoundException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), "Total Error: " + ex.getErrorCount()
				+ ". First error message is " + ex.getFieldError().getDefaultMessage(), request.getDescription(false));
